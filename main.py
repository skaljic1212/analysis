...
def main():
    ...
    # Top-down average-position map (formation chart), self-calibrated along
    # the pitch length using the two goalkeepers as anchors.
    pitch_map = PitchMap()
    ...
    print("Pitch map: average-position map saved to assets/player_map.png")
